...
class TestRiskManagement(unittest.TestCase):
    ...
    def test_monitor_positions_stop_hit(self, mock_check_stop):
        ...
        results = monitor_positions(self.mock_ib, [self.mock_position], self.config)
    ...
    def test_check_stop_loss_hit(self):
        ...
        result = check_stop_loss(current_price, stop_price, "bull")
        self.assertTrue(result)

        # Test for a short/bear position (stop is hit when price rises above stop)
        current_price = 96.0
        result = check_stop_loss(current_price, stop_price, "bear")
        self.assertTrue(result)
    ...
    def test_calculate_initial_stop(self):
        ...
        # Test the function
        result = calculate_initial_stop(stock_data, current_price, direction, atr_multiple)
