...
def run_benchmarks():
    ...
    for workers in [2, 4, 8]:
        par_signals, par_time = scan_parallel(all_data, high_base_condition_vectorized, max_workers=workers)
        print(f"Parallel scan ({workers} workers): {par_time:.6f} seconds, found {len(par_signals)} signals")
